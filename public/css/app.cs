...
@layer theme {
  :root, :host {
    ...
    --color-primary: #C2542E;
    --color-primary-dark: #8F3C1F;
    --color-secondary: #0F6E56;
    --color-secondary-dark: #085041;
    --color-sand-50: #FBF6EF;
    --color-sand-100: #F3E9D8;
    --color-sand-200: #E8DFCF;
...
@layer utilities {
  ...
  .bg-primary\/10 {
    background-color: color-mix(in srgb, #C2542E 10%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
  ...
  .bg-secondary\/10 {
    background-color: color-mix(in srgb, #0F6E56 10%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
      background-color: color-mix(in oklab, var(--color-secondary) 10%, transparent);
    }
  }
  .bg-secondary\/25 {
    background-color: color-mix(in srgb, #0F6E56 25%, transparent);
    @supports (color: color-mix(in lab, red, red)) {
