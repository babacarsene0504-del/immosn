...
<body style="font-family: Arial, sans-serif; background:#FBF6EF; padding:32px;">
    <div style="max-width:480px; margin:0 auto; background:#fff; border-radius:12px; overflow:hidden;">
        ...
        <div style="padding:32px;">
            <h1 style="font-size:20px; color:#2B2420;">Bienvenue, <?= htmlspecialchars($prenom, ENT_QUOTES, 'UTF-8') ?> 👋</h1>
            <p style="color:#5C5347; line-height:1.6;">
                Votre compte ImmoSn.com a bien été créé. Vous pouvez dès maintenant
                <?= $role === 'agence' ? 'publier vos biens et gérer votre catalogue.' : 'rechercher des biens ou publier votre première annonce.' ?>
            </p>
